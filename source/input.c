...
int input_read_parameters_general(struct file_content * pfc,
  ...
  char * options_output[36] =  {"tCl","pCl","lCl","nCl","dCl","sCl","mPk","mTk","dTk","vTk","sd","pm",
                                "TCl","PCl","LCl","NCl","DCl","SCl","MPk","MTk","DTk","VTk","Sd","pM",
                                "TCL","PCL","LCL","NCL","DCL","SCL","MPK","MTK","DTK","VTK","SD","PM"};
  ...
  if (flag1 == _TRUE_) {
    ...
    if ((strstr(string1,"pm") != NULL) || (strstr(string1,"pM") != NULL) || (strstr(string1,"PM") != NULL)) {
      ppt->has_perturbations = _TRUE_;
      ppt->has_source_TempMultipoles_g = _TRUE_;
      ppt->has_source_PolMultipoles_g = _TRUE_;
      ppt->has_cls = _TRUE_;
    }
    ...
    class_test(flag1==_FALSE_,
               errmsg, "The options for output are {'tCl','pCl','lCl','nCl','dCl','sCl','mPk','mTk','dTk','vTk','Sd','pM'}, you entered '%s'",string1);
  }
...
int input_default_params(struct background *pba,
  ...
  ppt->has_source_TempMultipoles_g = _FALSE_;
  ppt->has_source_PolMultipoles_g = _FALSE_;
  /** 1.a) 'tCl' case */
  ppt->switch_sw = 1;
  ppt->switch_eisw = 1;
  ppt->switch_lisw = 1;
