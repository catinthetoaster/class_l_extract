...
struct perturbations
{
  ...
  short has_source_TempMultipoles_g;
  short has_source_PolMultipoles_g;
  ...
  int index_tp_shear_g;      /**< photon shear */
  int index_tp_multT_g;      /**< photon l=3 and higher */
  int index_tp_multP_g;      /**< photon polarization */
